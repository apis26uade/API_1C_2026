...
export function LeafIcon({ size = 20 }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 21c-4-2.5-6.5-6.5-6.5-11a6.5 6.5 0 0 1 11-4.5C19 8 20 10 20 12c0 5-3.5 8.5-8 9Z" />
      <path d="M12 21V10" />
    </svg>
  )
}
...
export function CheckCircleIcon({ size = 22 }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="12" cy="12" r="10" fill="#9a8b82" />
      <path
...
export function RecycleIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function HeartOutlineIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function HeartIcon({ size = 11 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShoppingBagIcon({ size = 22 }) {
  return (
    <svg
      width={size}
      height={size}
